...
class _PremiumTextAnimatorState extends State<PremiumTextAnimator>
  ...
  Widget _buildSlideUpText() {
    ...
    .fadeIn(duration: (widget.duration.inMilliseconds * 0.6).round().milliseconds);
  }
  ...
  Widget _buildGlitchText() {
    ...
    .animate(delay: widget.delay, onPlay: (controller) => controller.repeat())
    .effect(
      duration: 100.ms,
      delay: 0.ms,
      curve: Curves.easeInOut,
  ...
  Widget _buildNeonText() {
    ...
    .animate(delay: widget.delay, onPlay: (controller) => controller.repeat(reverse: true))
